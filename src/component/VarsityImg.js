...
import C1 from '../images/Varsitypic/2.jpg';
import C2 from '../images/Varsitypic/3.jpg';
import C3 from '../images/Varsitypic/4.jpg';
import C4 from '../images/Varsitypic/5.jpg';
import C5 from '../images/Varsitypic/1.jpg';
import C6 from '../images/Varsitypic/2.jpg';

const VarsityImg = () => {
    return (
        <>
            <div className="my-5">
                <h1 className="text-center"> Varsity Images </h1>
            </div>
